...
target_dirs = ["UserService", "ShopService", "MessagingService", "AuthService", "BanService", "ConfigService", "PaymentService"]
    ...
    for source in data['propertySources']:
        ...
        for key, value in properties.items():
            ...
            if service == "user":
                ...
                script += f"export PAYMENT_{env_var}={value}\n"
...
#payment service
export PAYMENT_SERVER_PORT=8085
export PAYMENT_CONTAINER_PORT=8085
#container names
...
export PAYMENT_CONTAINER=payment-service
"""
