...
public class TransactionService {
  ...
  public Map<String, Object> addTransaction(@RequestBody Transaction transaction) {
    try {
      ...
      ResponseEntity<String> paymentResponse =
          restTemplate.postForEntity(fakePaymentServiceUrl, null, String.class);
      ...
      if (paymentResponse.getStatusCode() == HttpStatus.OK) {
        ...
        jdbcTemplate.update(
            connection -> {
              PreparedStatement ps =
                  connection.prepareStatement(sqlInsert, new String[] {"transactionId"});
        ...
        return Map.of(
            ...
            1,
            "message",
            "Transaction processed and saved successfully",
            "transactionId",
            transactionId);
      } else {
  ...
  public Map<String, Object> updateTransactionRefundState(
      @PathVariable int id, @RequestBody Transaction transaction) {
